package uk.co.aditya.springbootrest.service;
...
import uk.co.aditya.springbootrest.repo.JobRepo;
...
public class JobService {
    ...
    @Autowired
    public uk.co.aditya.springbootrest.repo.JobRepo repo;
    ...
    public List<JobPost> searchByKeyword(String key) {
